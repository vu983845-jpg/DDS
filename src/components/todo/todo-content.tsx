...
import { CheckCircle, Trash2, PlusCircle, AlertCircle } from 'lucide-react'
...
export function TodoContent({ todoData, user, profile }: TodoContentProps) {
