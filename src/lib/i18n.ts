export const dictionaries = {
    vi: {
        ...
        reasonOperatorError: 'Lỗi Vận Hành',
        reasonSensorMalfunction: 'Lỗi Cảm Biến',
        reasonJamming: 'Kẹt Máy/Tắc Nghẽn',
        reasonOther: 'Khác',
    ...
    en: {
        ...
        reasonSensorMalfunction: 'Sensor Malfunction',
        reasonJamming: 'Jamming/Blockage',
        reasonOther: 'Other',
